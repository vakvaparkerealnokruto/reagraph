...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react/jsx-runtime"), require("react"), require("@react-three/fiber"), require("d3-force-3d"), require("d3-hierarchy"), require("graphology-layout/circular.js"), require("graphology-layout-noverlap"), require("graphology-layout-forceatlas2"), require("graphology-layout/random.js"), require("graphology-metrics/centrality/pagerank.js"), require("graphology-metrics/centrality/degree.js"), require("d3-scale"), require("zustand"), require("zustand/context"), require("three"), require("@use-gesture/react"), require("graphology-shortest-path"), require("graphology"), require("glodrei"), require("ellipsize"), require("@react-spring/three"), require("camera-controls"), require("hold-event"), require("three-stdlib"), require("classnames")) : typeof define === "function" && define.amd ? define(["exports", "react/jsx-runtime", "react", "@react-three/fiber", "d3-force-3d", "d3-hierarchy", "graphology-layout/circular.js", "graphology-layout-noverlap", "graphology-layout-forceatlas2", "graphology-layout/random.js", "graphology-metrics/centrality/pagerank.js", "graphology-metrics/centrality/degree.js", "d3-scale", "zustand", "zustand/context", "three", "@use-gesture/react", "graphology-shortest-path", "graphology", "glodrei", "ellipsize", "@react-spring/three", "camera-controls", "hold-event", "three-stdlib", "classnames"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.reagraph = {}, global.jsxRuntime, global.react, global.fiber, global.d3Force3d, global.d3Hierarchy, global.circular, global.noverlapLayout, global.forceAtlas2Layout, global.random, global.pagerank, global.degree_js, global.d3Scale, global.zustand, global.createContext, global.three, global.react$1, global.graphologyShortestPath, global.Graph, global.glodrei, global.ellipsize, global.three$1, global.ThreeCameraControls, global.holdEvent, global.threeStdlib, global.classNames));
})(this, function(exports2, jsxRuntime, react, fiber, d3Force3d, d3Hierarchy, circular, noverlapLayout, forceAtlas2Layout, random, pagerank, degree_js, d3Scale, zustand, createContext, three, react$1, graphologyShortestPath, Graph, glodrei, ellipsize, three$1, ThreeCameraControls, holdEvent, threeStdlib, classNames) {
  "use strict";
  var _a, _b;
  ...
  function calcLabelVisibility({
    ...
    return (shape, size) => {
      var _a2;
      if (camera && nodePosition && ((_a2 = camera == null ? void 0 : camera.position) == null ? void 0 : _a2.z) / (camera == null ? void 0 : camera.zoom) - (nodePosition == null ? void 0 : nodePosition.z) > 1e5) {
        return false;
      }
      if (labelType === "all") {
        return true;
